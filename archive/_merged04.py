...
# python3 _merged04.py https://www.youtube.com/watch?v=v51Es-7RKig
...
parser = argparse.ArgumentParser(description="Process a YouTube video: download audio, transcribe, and add metadata.")
